...
def get_info_from_db(teacher_id, _id):
    ...
    teacher_info_from_basic = collection.find_one({"id": teacher_id},
                                                  {'_id': 0, 'funds_id': 0, 'patent_id': 0, 'paper_id': 0,
                                                   'project_id': 0, 'award_id': 0, 'research_plan_id': 0})
    agent_feedback = mogo_operator.get_collection('agent_feedback')
...
def get_teacher(school, institution):
    ...
    teacher_list = list(basic_info_col.find({"school": school, "institution": institution},
...
if __name__ == "__main__":
    # 测试
    teacher_info = {'name': '王冬梅', 'school': '中国农业大学', 'institution': '马克思主义学院', 'title': '教授', 'birth_year': '',
                    'email': '11@qq.com', 'office_number': ' 1234', 'phone_number': '111',
                    'edu_exp': '1994-1997 北京大学，获得硕士学位2004—2008 中国农业大学，获得博士学位'}
